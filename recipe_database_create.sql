...
create table ingredient (id bigint not null auto_increment, description varchar(255), quantity decimal(19,2), recipe_id bigint, uom_id bigint, primary key (id)) engine=InnoDB;
create table notes (id bigint not null auto_increment, recipe_notes longtext, recipe_id bigint, primary key (id)) engine=InnoDB;
create table recipe (id bigint not null auto_increment, cook_time integer, description varchar(255), difficulty varchar(255), directions varchar(255), image longblob, prep_time integer, servings integer, source varchar(255), title varchar(255), url varchar(255), notes_id bigint, primary key (id)) engine=InnoDB;
